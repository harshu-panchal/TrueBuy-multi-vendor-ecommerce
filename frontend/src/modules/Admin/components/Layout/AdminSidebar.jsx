...
const getChildRoute = (parentRoute, childName) => {
  const routeMap = {
    ...
    "/admin/configuration": {
      Plan: "/admin/configuration/plans",
      "Set Uplevel": "/admin/configuration/uplevel",
...
const AdminSidebar = ({ isOpen, onClose }) => {
  ...
  return (
    <>
      ...
      <div
        className={`hidden lg:flex fixed left-0 top-0 bottom-0 w-64 z-40 transition-transform duration-300 ${
